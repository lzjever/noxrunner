...
def get_base_url() -> str:
    ...
    return os.environ.get('NOXRUNNER_BASE_URL', 'http://127.0.0.1:8080')


def cmd_health(args):
    """Health check command."""
    client = NoxRunnerClient(args.base_url, timeout=args.timeout)
    try:
...
Environment Variables:
  NOXRUNNER_BASE_URL    Base URL of the NoxRunner (default: http://127.0.0.1:8080)
    ...
    parser.add_argument(
        ...
        help='Base URL of the NoxRunner (default: from NOXRUNNER_BASE_URL env or http://127.0.0.1:8080)'
    )
    parser.add_argument(
        '--timeout',
        type=int,
    ...
    create_parser.add_argument('--wait-timeout', type=int, default=30, help='Wait timeout in seconds (default: 30)')
    ...
    exec_parser.add_argument('--workdir', default='/workspace', help='Working directory (default: /workspace)')
    exec_parser.add_argument('--env', action='append', help='Environment variable (KEY=VALUE)')
    exec_parser.add_argument('--timeout-seconds', type=int, default=30, help='Command timeout (default: 30)')
    exec_parser.add_argument('--ignore-exit-code', action='store_true', help='Ignore non-zero exit codes')
    ...
    upload_parser.add_argument('--dest', default='/workspace', help='Destination directory (default: /workspace)')
    ...
    download_parser.add_argument('--src', default='/workspace', help='Source directory (default: /workspace)')
    download_parser.add_argument('--output', help='Output tar file (if not specified, extracts to current directory)')
    ...
    shell_parser.add_argument('--workdir', default='/workspace', help='Working directory (default: /workspace)')
    shell_parser.add_argument('--timeout-seconds', type=int, default=30, help='Command timeout (default: 30)')
