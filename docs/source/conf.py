...
try:
    from noxrunner import __version__
except ImportError as e:
    raise ImportError(
        f"Failed to import noxrunner.__version__: {e}. "
...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/noxrunner/noxrunner",
            "html": """
    ...
    "source_repository": "https://github.com/noxrunner/noxrunner",
    "source_branch": "main",
